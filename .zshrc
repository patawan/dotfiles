...
# fi
eval "$(oh-my-posh init zsh --config ~/.config/omp-themes/multiverse-neon-extra.omp.json)"
...
plugins=(git zsh-syntax-highlighting zsh-autosuggestions terraform) # zsh-autocomplete fzf zoxide
